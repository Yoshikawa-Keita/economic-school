...
var (
	filter_EconomicSchool_VerifyEmail_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_EconomicSchool_VerifyEmail_0(ctx context.Context, marshaler runtime.Marshaler, client EconomicSchoolClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_EconomicSchool_VerifyEmail_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterEconomicSchoolHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EconomicSchoolServer) error {
	...
	mux.Handle("GET", pattern_EconomicSchool_VerifyEmail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("GET", pattern_EconomicSchool_ListExams_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.EconomicSchool/ListExams", runtime.WithHTTPPathPattern("/v1/exams"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterEconomicSchoolHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EconomicSchoolClient) error {
	...
	mux.Handle("GET", pattern_EconomicSchool_ListExams_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pb.EconomicSchool/ListExams", runtime.WithHTTPPathPattern("/v1/exams"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_EconomicSchool_ListExams_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "exams"}, ""))
